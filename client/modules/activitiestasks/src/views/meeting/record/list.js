...
Espo.define('activitiestasks:views/meeting/record/list', 'views/record/list', function (Dep) {

    return Dep.extend({

        rowActionsView: 'activitiestasks:views/meeting/record/row-actions/default',
