...
Espo.define('activitiestasks:views/record/panels/activities', ['views/record/panels/relationship', 'multi-collection'], function (Dep, MultiCollection) {

    return Dep.extend({

        name: 'activities',

        template: 'activitiestasks:record/panels/activities',
        ...
        rowActionsView: 'activitiestasks:views/record/row-actions/activities',
        ...
        defaultListLayout: {
            rows: [
                [
                    {name: 'ico', view: 'activitiestasks:views/fields/ico'},
                    {name: 'name', link: true}
                ],
                [
                    {name: 'assignedUser'},
