...
Espo.define('activitiestasks:views/record/panels/history', 'activitiestasks:views/record/panels/activities', function (Dep) {
    ...
    return Dep.extend({
        ...
        rowActionsView: 'activitiestasks:views/record/row-actions/history',
